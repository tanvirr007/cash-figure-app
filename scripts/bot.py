...
def monitor():
    ...
    app_name = os.environ.get("APP_NAME", "Cash Figure")
...
def release():
    ...
    reply_markup = {
        "inline_keyboard": [
            [
                {"text": "Direct", "url": f"https://github.com/{repo}/releases/latest/download/CashFigure.apk"},
                {"text": "Versioned", "url": f"https://github.com/{repo}/releases/download/v{version}/CashFigure-v{version}.apk"}
            ]
        ]
    }
